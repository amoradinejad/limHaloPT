...
double {\bfseries p\+\_\+sig\+\_\+shot} (double scatter)
\item 
...
double {\bfseries p\+\_\+sig\+\_\+\+Tbar} (double scatter)
\item 
...
\item p\+\_\+sig\+\_\+shot() computes the coefficient accounting for the scatter in L(\+M) in shot noise
\item p\+\_\+sig\+\_\+\+Tbar() computes the coefficient accounting for the scatter in L(\+M) in mean brightness temprature
...
in unit of L\+\_\+sunHere is the caller graph for this function\+:
% FIG 9
...
in unit of erg/s\mbox{\Hypertarget{line__ingredients_8c_ae44a16b587a91c0ea92dea263d20a5be}\label{line__ingredients_8c_ae44a16b587a91c0ea92dea263d20a5be}} 
...
factor of 10$^\wedge$6 is the conversion factor from K to microKHere is the caller graph for this function\+:
% FIG 20
