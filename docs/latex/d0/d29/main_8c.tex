...
Given the number of lines you chose with nline, the line\mbox{[}\mbox{]} array and JJ\mbox{[}\mbox{]} arrays will be initialized here. Note that at the moment you can only call the lines in the order below.
