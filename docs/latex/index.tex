...
\item To compile, within the main directory of lim\+Halo\+PT, type\+: \char`\"{}make\char`\"{} ~\newline
 This would create an executable called \char`\"{}lim\+Halo\+PT\char`\"{} in the same directory, which you will use to run the code. If you modified the code, you need to first do \char`\"{}make clean\char`\"{} before doing \char`\"{}make\char`\"{}.
\end{DoxyItemize}
