...
double \mbox{\hyperlink{ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce}{PS\+\_\+shot\+\_\+\+HM}} (struct \mbox{\hyperlink{struct_cosmology}{Cosmology}} $\ast$Cx, double k, double z, double M\+\_\+min, double $\ast$input, long mode\+\_\+mf, long line\+\_\+type, int line\+\_\+id)
...
\begin{DoxyCompactList}\small\item\em The integrand function passed passed to Cuhre integration routine of CUBA library to compute the corrections to mass integration. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em The integrand function passed passed to Cuhre integration routine to compute 1-\/ and 2-\/halo integrals. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute the mass integrals needed for 1-\/ and 1-\/halo line, line-\/matter and matter power spectrum If nfw=1, the dependance of the power spectrum on the halo profile is neglected. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em The integrand function passed passed to Cuhre integration routine to compute large-\/scale limit of b22 (shot-\/noise contribution) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute the large-\/scale limit of P\+\_\+b2b2 loop. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item \mbox{\hyperlink{ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce}{PS\+\_\+shot\+\_\+\+HM()}} to compute the stochastic contrubutions beyond Poisson shot noise (see ar\+Xiv\+:1706.\+08738)
\end{DoxyItemize}
...
\begin{DoxyEnumerate}
\item \mbox{\hyperlink{ps__line__hm_8c_ab3acf266df779fd7b847b2ca641efa01}{PS\+\_\+line\+\_\+\+HM()}} computes the 1loop-\/\+HM line power spectrum
\item \mbox{\hyperlink{ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce}{PS\+\_\+shot\+\_\+\+HM()}} computes the full line power spectrum, beyond poisson limit
...
\begin{center}
\leavevmode
\includegraphics[width=310pt]{d1/dd5/ps__line__hm_8c_aebed249f1a0afb0c6f7bcadcd3f1f4ee_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/dd5/ps__line__hm_8c_a4e1bbff7f992103c9b1fa8f5abc1f408_icgraph}
\end{center}
\end{figure}
...
\end{DoxyItemize}\\
\hline
{\em result} & Output\+: anarray of the integration results. Number of elements varies depending on mode\+\_\+hm switch\+:
\begin{DoxyItemize}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
void in unit of M\+\_\+sun/\+Mpc$^\wedge$3 
\end{DoxyReturn}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
...
\begin{center}
\leavevmode
\includegraphics[width=324pt]{d1/dd5/ps__line__hm_8c_a298eb563414c8e40e35481cb64c2f509_icgraph}
\end{center}
\end{figure}
...
\hline
{\em result} & Output\+: a 2d array of the integration results,
\begin{DoxyItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=225pt]{d1/dd5/ps__line__hm_8c_ab3acf266df779fd7b847b2ca641efa01_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce}\label{ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce}} 
...
{\footnotesize\ttfamily double PS\+\_\+shot\+\_\+\+HM (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{struct_cosmology}{Cosmology}} $\ast$}]{Cx,  }\item[{double}]{k,  }\item[{double}]{z,  }\item[{double}]{M\+\_\+min,  }\item[{double $\ast$}]{input,  }\item[{long}]{mode\+\_\+mf,  }\item[{long}]{line\+\_\+type,  }\item[{int}]{line\+\_\+id }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/dd5/ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=229pt]{d1/dd5/ps__line__hm_8c_a783807d3525deda32e00ecdf21d7c6ce_icgraph}
\end{center}
\end{figure}
