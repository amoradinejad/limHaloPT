...
This package is released together with the following publication, arxiv:2111.XXXXX, where the prediction of the model are tested against new suite of simulated intensity (brightness temprature) maps of CO and [CII] lines. The mesheded fileds from MithraLIMSims will be publically avilable on [MithraLIMSims](http://cyril.astro.berkeley.edu/MithraLIMSims).  As discussed in the paper, this code can be straightforwardly extended to compute the power spectrum signal of other emission lines (emitted from star-froming galaxies), beside CO and [CII]. 
<br>

The full documentation of the code, which still is under developement, can be found on [Documentation](https://amoradinejad.github.io/limHaloPT/html/index.html).
...
Moradinezhad & Nikakhtar & Keating & Castorina: arXiv:2111.XXX. Furthermore, free usage of [CLASS](https://github.com/lesgourg/class_public) requires citation of at least one of the CLASS [papers](https://arxiv.org/abs/1104.2933). 
<br>
